...
document.addEventListener('DOMContentLoaded', async (event) => {
    ...
    if (searchResultsContainer && searchResultsContainer.querySelector('h1') != null) {
    ...
    if (currentUser) {
        ...
        const profileButton = document.querySelector('.profile')?.querySelector('.profile-button') ?? null;
